...
class CausalText(nn.Module):
    ...
    def __init__(
        ...
        self.config = {
            ...
            'htr_freeze_sentence_encoder': htr_freeze_sentence_encoder,
            'htr_chunk_size_words': htr_chunk_size_words,
            'htr_chunk_overlap_words': htr_chunk_overlap_words,
            'htr_max_chunks': htr_max_chunks,
            'htr_max_chunk_length': htr_max_chunk_length,
            'htr_num_layers': htr_num_layers,
            'htr_num_heads': htr_num_heads,
            'htr_transformer_dim': htr_transformer_dim,
            'htr_dropout': htr_dropout,
            'htr_projection_dim': htr_projection_dim,
            'htr_hash_embedding_dim': htr_hash_embedding_dim,
            'htr_sentence_encoder_batch_size': htr_sentence_encoder_batch_size,
            'htr_sentence_encoder_backend': htr_sentence_encoder_backend,
            ...
            'ctcnn_model_name': ctcnn_model_name,
            'ctcnn_chunk_size': ctcnn_chunk_size,
            'ctcnn_chunk_overlap': ctcnn_chunk_overlap,
            'ctcnn_max_chunks': ctcnn_max_chunks,
            'ctcnn_confounder_concepts': ctcnn_confounder_concepts,
            'ctcnn_effect_modifier_concepts': ctcnn_effect_modifier_concepts,
            'ctcnn_random_features': ctcnn_random_features,
            ...
            'ctcnn_anchor_weight': ctcnn_anchor_weight,
            'ctcnn_cached_hidden_size': ctcnn_cached_hidden_size,
        ...
        self.feature_extractor = create_feature_extractor(
            ...
            ctcnn_chunk_overlap=ctcnn_chunk_overlap,
            ctcnn_max_chunks=ctcnn_max_chunks,
            ctcnn_confounder_concepts=ctcnn_confounder_concepts or [],
            ctcnn_effect_modifier_concepts=ctcnn_effect_modifier_concepts or [],
            ctcnn_random_features=ctcnn_random_features,
            ctcnn_random_confounder_features=ctcnn_random_confounder_features,
            ctcnn_random_modifier_features=ctcnn_random_modifier_features,
            ctcnn_kernel_role="combined",
            ctcnn_projection_dim=ctcnn_projection_dim,
            ctcnn_dropout=ctcnn_dropout,
            ctcnn_anchor_weight=ctcnn_anchor_weight,
            ctcnn_cached_hidden_size=ctcnn_cached_hidden_size,
