...
Typical quick run:
    ...
    python oracle_experiment_scripts/run_neural_causal_forest_oracle.py \
        ...
        --encoder-model prajjwal1/bert-tiny --nuisance-epochs 20 --forest-epochs 40
...
For no-download smoke tests, use ``--encoder-backend hash --nuisance-epochs 1
--forest-epochs 1 --sample-size 64``.
"""
