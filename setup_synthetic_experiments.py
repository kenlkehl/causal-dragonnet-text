...
target_base = Path("../pcori_experiments/rethink_confounders_synthetic_data/experiments_1-5-26")
dataset_path = current_dir / "example_synthetic_dataset/dataset.parquet"
...
for exp_dir in experiment_dirs:
    ...
    if 'applied_inference' in config:
        config['applied_inference']['dataset_path'] = str(dataset_path)
        config['applied_inference']['split_column'] = None # Synthetic data has no split column
